...
import com.fengzi.picurelibrary.utils.Utils;
...
public class ImageSelectorActivity extends FragmentActivity implements ImageSelectorFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton = findViewById(R.id.title_right);
        title_text = findViewById(R.id.title_text);
        imageselector_title_bar_layout = findViewById(R.id.imageselector_title_bar_layout);
        init();
        openImageFrg();
    }
